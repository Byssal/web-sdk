...
export const bookEventHandlerMap: BookEventHandlerMap<BookEvent, BookEventContext> = {
	...
	// Viking: 3-tier scatter bonus entry. reason is 'raid' | 'expedition' | 'ragnarok'.
	enterBonus: async (bookEvent: BookEventOfType<'enterBonus'>) => {
		await eventEmitter.broadcastAsync({ type: 'bonusIntroShow', tier: bookEvent.reason });
	},
	// customised
